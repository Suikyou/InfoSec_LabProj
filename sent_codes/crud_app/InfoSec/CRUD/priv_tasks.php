...
<div class="container">
    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        <tbody>
        <?php
        // Query to select private tasks associated with the current user
        $query = "SELECT * FROM private_tasks WHERE private_user_id_fk = $user_id";
        ...
        if (!$result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                    ...
                    <td><a href="update_task_priv.php?id=<?php echo $row['private_tasks_id_pk']; ?>" class="btn btn-success" onclick="return confirm('Are you sure you want to update this task?')">Update</a></td>
